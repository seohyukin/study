		...
		<table class="table_type01" style="width: 900px">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					  ...
					  <p>
					   ...
					   <input type="text" name="" id="s_id" class="join"/>
				...
				<tr>
					...
					<td>
					  ...
					  <p>
					   ...
					   <input type="password" name="" id="s_pw" class="join"/>					    
					  </p>
					</td>
				</tr>
				<tr>
					...
					<td>
					  ...
					  <p>
					   ...
					   <input type="password" name="" id="s_pw2"  class="join"/>					    
					  </p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					관심기부대상</th>
					<td>
					  <input type="checkbox" name="give" id="ch01"/>
					  <label for="ch01">아동</label>
					  &nbsp;
					  <input type="checkbox" name="give" id="ch02"/>
					  <label for="ch02">노인</label>
					  &nbsp;
					  <input type="checkbox" name="give" id="ch03"/>
					  <label for="ch03">건강</label>
					  &nbsp;
					  <input type="checkbox" name="give" id="ch04"/>
					  <label for="ch04">학습</label>
					  &nbsp;
					  <input type="checkbox" name="give" id="ch05"/>
